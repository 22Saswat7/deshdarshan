...
// Import pricing data
import { destinationPricing } from './pricingData';
  ...
  Odisha: [
    {
      ...
      pricing: destinationPricing.puri
    },
    {
      name: "Konark",
      ...
      pricing: destinationPricing.konark
    },
    {
      name: "Nandankanan",
      ...
      pricing: {
        entryFee: 50,
        activities: [
          { name: "Zoo Entry", price: 50, unit: "per person" },
          { name: "Safari Ride", price: 100, unit: "per person" },
          { name: "Boating", price: 80, unit: "per person" }
        ]
      }
    },
    {
      ...
      pricing: destinationPricing.chilika
    },
    {
      name: "Deomali",
      ...
      pricing: {
        entryFee: 0,
        activities: [
          { name: "Trekking Guide", price: 500, unit: "per group" },
          { name: "Camping", price: 300, unit: "per person" }
        ]
      }
    }
  ],
  "West Bengal": [
    {
      ...
      pricing: destinationPricing.kolkata
    },
    {
      name: "Darjeeling",
      ...
      pricing: destinationPricing.darjeeling
    },
    {
      name: "Sundarbans",
  ...
  Bihar: [
    {
      ...
      pricing: destinationPricing.bodhGaya
    },
    {
      name: "Nalanda",
      ...
      pricing: destinationPricing.nalanda
    },
    {
      name: "Patna",
      ...
      pricing: destinationPricing.patna
    },
    {
      name: "Rajgir",
